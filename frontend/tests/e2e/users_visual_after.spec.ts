...
test('verify users page layout after modernization', async ({ page }) => {
    ...
    await page.screenshot({ path: '/Users/tobiasmorixbauer/.gemini/antigravity/brain/e02770e0-8393-439a-bbca-82a03aca2147/users_after_desktop.png', fullPage: true });

    // Mobile Screenshot
    await page.setViewportSize({ width: 375, height: 667 });
    await page.waitForTimeout(500);
    await page.screenshot({ path: '/Users/tobiasmorixbauer/.gemini/antigravity/brain/e02770e0-8393-439a-bbca-82a03aca2147/users_after_mobile.png', fullPage: true });
});
