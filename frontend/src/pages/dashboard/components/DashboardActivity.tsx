...
export function DashboardActivity({ data, visible }: DashboardActivityProps) {
      ...
      <article className="subpanel">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="dashboard-activity-card">
            <div className="text-2xl font-bold">{data?.movements_today ?? "-"}</div>
            <div className="dashboard-activity-label">Bewegungen</div>
          </div>
          <div className="dashboard-activity-card">
            <div className="text-2xl font-bold">{data?.completed_goods_receipts_today ?? "-"}</div>
            <div className="dashboard-activity-label">Wareneingänge</div>
          </div>
          <div className="dashboard-activity-card">
            <div className="text-2xl font-bold">{data?.completed_goods_issues_today ?? "-"}</div>
            <div className="dashboard-activity-label">Warenausgänge</div>
          </div>
          <div className="dashboard-activity-card">
            <div className="text-2xl font-bold">{data?.completed_stock_transfers_today ?? "-"}</div>
